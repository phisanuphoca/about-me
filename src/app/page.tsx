...
export default function Home() {
	return (
		...
		//	</div>
		//</div>
		<div className="h-screen font-[family-name:var(--font-geist-sans)] bg-[#FFF2E1]">
			<main className="flex flex-col gap-8 row-start-2 max-w-screen-lg m-auto h-full bg-red-400">
				<div>
					<div className="bg-slate-700 max-w-xl h-[200px] m-auto flex justify-center items-center gap-6">
						<div className="w-[150px] h-[150px] rounded-full border-4 border-white overflow-hidden">
							<Image
						...
						<div className=" flex flex-col gap-4">
							<div className="text-4xl">Phisanu Phoca</div>
